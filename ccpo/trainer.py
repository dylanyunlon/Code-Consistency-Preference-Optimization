...
class CCPOTrainer(Trainer):
    ...
    Args:
        ...
        beta (`float`, defaults to 0.1):
            The beta factor in DPO loss. In CCPO, eta=1/beta. Higher beta means less divergence from the initial policy. For the IPO loss, beta is the regularization parameter denoted by tau in the paper.
    ...
    def tokenize_row(self, feature, model: Union[PreTrainedModel, nn.Module] = None) -> Dict:
        """Tokenize a single row from a CCPO specific dataset.
    ...
    def ccpo_loss(
        ...
        """Compute the CCPO loss for a batch of policy and reference model log probabilities.
        ...
        Returns:
            ...
            The losses tensor contains the CCPO loss for each example in the batch.
        ...
        # The beta is a temperature parameter for the DPO loss, typically something in the range of 0.1 to 0.5. In CCPO, beta=1/eta has a different meaning, and is usually chosen around 1e-3.
        # We ignore the reference model as beta -> 0. The label_smoothing parameter encodes our uncertainty about the labels and
        # calculates a conservative CCPO loss.
    ...
    def get_batch_loss_metrics(
        ...
        """Compute the CCPO loss and other metrics for the given batch of inputs for train or test."""
        metrics = {}
